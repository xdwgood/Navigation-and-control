...
#include <ros_learn_action/FibonacciAction.h>
...
int main (int argc, char **argv)
{
  ...
  actionlib::SimpleActionClient<ros_learn_action::FibonacciAction> ac("fibonacci", true);
  ...
  ros_learn_action::FibonacciGoal goal;
  goal.order = 4;        
